...
Public Class PdfManipulation2
    ...
    Public Overloads Shared Sub ExtractPdfPage(ByVal sourcePdf As String, ByVal pageNumberToExtract As Integer, ByVal outPdf As String)
        ...
        Try
            ...
            pdfCpy.AddPage(page)
            Dim textFont As iTextSharp.text.Font = iTextSharp.text.FontFactory.GetFont(iTextSharp.text.FontFactory.HELVETICA, 12, iTextSharp.text.Font.NORMAL)
            Dim arial As BaseFont = BaseFont.CreateFont("C:\WINDOWS\Fonts\arial.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED)
            Dim plLarge As New iTextSharp.text.Font(arial, 16)
            Dim polish As String = "\u0104\u0105\u0106\u0107\u0118\u0119"
            pdfCpy.Add(New iTextSharp.text.Paragraph("Title of the document", textFont))
            Dim i As Integer
            Dim sOut = ""

            For i = 1 To reader.NumberOfPages
                Dim its As New iTextSharp.text.pdf.parser.SimpleTextExtractionStrategy
                sOut = iTextSharp.text.pdf.parser.PdfTextExtractor.GetTextFromPage(reader, i, its)
                pdfCpy.Add(New iTextSharp.text.Paragraph(sOut, textFont))
            Next
    ...
    Public Overloads Shared Sub ExtractPdfPagef(ByVal sourcePdf As String, ByVal pageNumbersToExtract As Integer(), ByVal outPdf As String)
        Dim reader As iTextSharp.text.pdf.PdfReader = Nothing
        Dim doc As iTextSharp.text.Document = Nothing
        Dim pdfCpy As iTextSharp.text.pdf.PdfCopy = Nothing
        Dim page As iTextSharp.text.pdf.PdfImportedPage = Nothing
        Try
            ...
            For Each pageNum As Integer In pageNumbersToExtract
                ...
                pdfCpy.AddPage(page)
                pdfCpy.Add(New iTextSharp.text.Paragraph("Title of the document", plLarge))
    ...
    Public Shared Sub FillAcroForm(ByVal sourcePdf As String, ByVal fieldData As DataRow, ByVal outputPdf As String)
        Try
            ...
            Dim fields As System.Collections.Generic.Dictionary(Of String, iTextSharp.text.pdf.AcroFields.Item) = frm.Fields
    ...
    Public Shared Sub FillMyForm(ByVal sourcePdf As String, ByVal fieldData As DataRow, ByVal outputPdf As String)
        Try
            ...
            Dim boxSize() As Single = frm.GetFieldPositions("History")
            Dim rect As New iTextSharp.text.Rectangle(boxSize(1), boxSize(2), boxSize(3), boxSize(4))
            ...
            For Each col As DataColumn In fieldData.Table.Columns
                ...
                If key.ToUpper = "HISTORY" Then
                    ...
                    If histTxt.Length > charLimit Then
                        ...
                        Dim newRect As New iTextSharp.text.Rectangle(boxSize(1), 750, boxSize(3), 50)
    ...
    Public Shared Function ReplacePagesWithBlank(ByVal sourcePdf As String, _
        ...
        Try
            ...
            If String.IsNullOrEmpty(templatePdf) Then
                templatePdf = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments) & "\BlankPageTemplate.pdf"
                deleteTemplate = True
